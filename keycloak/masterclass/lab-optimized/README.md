...
3) Nimm an der Compose File folgende Änderungen vor:
    - Setze das Image auf `my-own-keycloak`
...
3) Make the following changes to the Compose File:
    - Set the image to `my-own-keycloak`
